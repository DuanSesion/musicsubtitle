//
//  OMCollectionViewWaterfallLayout.swift
//  haimetaverse
//
//  Created by Mark on 2023/8/2.
//
...
@objc protocol ZDCollectionViewDelegateWaterfallLayout: UICollectionViewDelegate{
...
enum ZDCollectionViewWaterfallLayoutItemRenderDirection : NSInteger{
    case shortestFirst
    case leftToRight
    case rightToLeft
}

class ZDCollectionViewWaterfallLayout : UICollectionViewLayout{
    let ZDCollectionElementKindSectionHeader = "header"
    let ZDCollectionElementKindSectionFooter = "footer"
    ...
    var itemRenderDirection : ZDCollectionViewWaterfallLayoutItemRenderDirection{
    didSet{
        invalidateLayout()
    }}
...
//    private property and method above.
    weak var delegate : ZDCollectionViewDelegateWaterfallLayout?{
    get{
        return self.collectionView!.delegate as? ZDCollectionViewDelegateWaterfallLayout
    }
    }
    ...
    override func prepare(){
        ...
        for section in 0 ..< numberOfSections{
            ...
            */
            ...
            if heightHeader > 0 {
                attributes = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: ZDCollectionElementKindSectionHeader, with: IndexPath(row: 0, section: section))
            ...
            */
            ...
            if footerHeight > 0 {
                attributes = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: ZDCollectionElementKindSectionFooter, with: IndexPath(item: 0, section: section))
    ...
    override func layoutAttributesForSupplementaryView(ofKind elementKind: String, at indexPath: IndexPath) -> UICollectionViewLayoutAttributes{
        ...
        if elementKind == ZDCollectionElementKindSectionHeader{
            attribute = self.headersAttributes.object(forKey: indexPath.section) as! UICollectionViewLayoutAttributes
        }else if elementKind == ZDCollectionElementKindSectionFooter{

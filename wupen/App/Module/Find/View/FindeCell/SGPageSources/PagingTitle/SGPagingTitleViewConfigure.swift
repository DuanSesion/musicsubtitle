...
public class SGPagingTitleViewConfigure: NSObject  {
    ...
    @objc public var selectedFont: UIFont = .systemFont(ofSize: 18)
    ...
    @objc public var indicatorImg: UIImage?
    
    @objc public var itemNomarlColor: UIColor = .clear
    @objc public var itemSelectedColor: UIColor = .clear
    @objc public var radues: CGFloat = 0
}

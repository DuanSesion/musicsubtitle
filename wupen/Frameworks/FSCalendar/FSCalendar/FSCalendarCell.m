...
@property (nonatomic, weak) CAShapeLayer *dottedLineLayer;
...
//        icon.layer.borderColor = [UIColor whiteColor].CGColor;
        icon.backgroundColor =  [UIColor colorWithRed:255/255.0 green:145/255.0 blue:16/255.0  alpha:1];
    }
    return _icon;
}
...
- (CAShapeLayer *)bgShapeLayer {
    if (!_bgShapeLayer) {
        ...
        //rgba(255, 145, 16, 1)
        shapeLayer.backgroundColor = [UIColor colorWithRed:255/255.0 green:145/255.0 blue:16/255.0  alpha:1].CGColor;
...
- (CAShapeLayer *)dottedLineLayer {
    if (!_dottedLineLayer) {
        CAShapeLayer *shapeLayer = [CAShapeLayer layer];
        shapeLayer.borderColor = [UIColor colorWithRed:254/255.0 green:143/255.0 blue:11/255.0 alpha:1].CGColor;
...
//        shapeLayer.strokeColor = [UIColor colorWithRed:254/255.0 green:143/255.0 blue:11/255.0 alpha:1].CGColor;
     
//        shapeLayer.lineWidth = 1;
        [self.contentView.layer insertSublayer:shapeLayer atIndex:0];
        _dottedLineLayer = shapeLayer;
    }
...
//    FSCalendarEventIndicator *eventIndicator = nil;
    
    self.bgShapeLayer.opacity = 1;
...
//    self.imageView = imageView;
    ...
    self.shapeState = FSCalendarShapeAll;
}
...
//    if (_subtitle) {
//        CGFloat titleHeight = MAX(self.titleLabel.font.lineHeight,26);
...
//    }
    ...
    self.icon.frame = CGRectMake((self.contentView.fs_width - 8)/2, _titleLabel.fs_bottom + 5, 8, 8);
...
//                                      );
    ...
    if (self.shapeState == FSCalendarShapeNone) {
        self.bgShapeLayer.frame = CGRectMake((self.bounds.size.width-26)/2, 0, 26, 26);
        
    } else if (self.shapeState == FSCalendarShapeTop) {
//        self.bgShapeLayer.frame = CGRectMake((self.bounds.size.width-60)/2, 0, 60, _titleLabel.fs_height);
        self.bgShapeLayer.frame = CGRectMake((self.bounds.size.width-26)/2, 0, 26, 26);
    ...
    if (self.isToday) {
        ...
        self.bgShapeLayer.frame = CGRectMake((self.bounds.size.width-0)/2, 0, 0, 0);
        //self.titleLabel.textColor = [UIColor colorWithRed:0.2 green:0.2 blue:0.2 alpha:1];
    }
    self.titleLabel.adjustsFontSizeToFitWidth = YES;
    
    if (self.dotState == FSCalendarDotNone) {
        self.icon.backgroundColor = [UIColor clearColor];
        
    } else if (self.dotState == FSCalendarDotRed)  {
        self.icon.backgroundColor = [UIColor colorWithRed:255/255.0 green:145/255.0 blue:16/255.0  alpha:1];
         
    } else {
        self.icon.backgroundColor = [UIColor colorWithRed:211/255.0 green:211/255.0 blue:211/255.0  alpha:1];
    }
    
    
//    self.dottedLineLayer.path = [UIBezierPath bezierPathWithRoundedRect:self.dottedLineLayer.bounds cornerRadius:2].CGPath;
    
//    if (self.isToday) {
//        self.dottedLineLayer.strokeColor = [UIColor colorWithRed:88/255.0 green:105/255.0 blue:1 alpha:1].CGColor;
//    } else {
//        self.dottedLineLayer.strokeColor = [UIColor clearColor].CGColor;
//    }
}
...
- (void)layoutSubviews
{
    ...
    self.accessibilityIdentifier = @"xxx";

...
typedef NS_ENUM(NSUInteger, FSCalendarShapeState) {
    FSCalendarShapeNone = 0,
    FSCalendarShapeTop,
    FSCalendarShapeAll
};

typedef NS_ENUM(NSUInteger, FSCalendarDotState) {
    FSCalendarDotNone = 0,
    FSCalendarDotRed,
    FSCalendarDotGay
};
...
//MARK: --------xx
@property (assign, nonatomic) FSCalendarShapeState shapeState;
@property (weak,   nonatomic) UIImageView *icon;
@property (assign, nonatomic) BOOL isToday;
@property (assign, nonatomic) FSCalendarDotState dotState;

...
@optional
- (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView left:(NSInteger)index;
- (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView right:(NSInteger)index;
